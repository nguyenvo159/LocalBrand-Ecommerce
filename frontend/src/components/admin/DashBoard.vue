<template>
    ...
    <!-- Admin Sidebar -->
    <div class="col-lg-3 bg-dark admin-sidebar">

        <h3 class="admin-title" style="height: 52px; letter-spacing: 10px;"><span>AMIE</span></h3>
        <hr>
        <div class="py-3">
            ...
            <router-link :to="{ name: 'AnalyticsManage' }" :class="{ 'active': type == 'Analytics' }">
                <i class="fa-solid fa-chart-line"></i><span>Analytics</span></router-link>
        </div>
        <hr>
        <div>
            <a class="">
